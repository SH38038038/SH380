...
export const metadata: Metadata = {
  ...
  description: '낯선 기술의 바다에서 길을 잃는 것을 즐깁니다. 그 과정 끝에 더 나은 답이 있음을 믿기 때문입니다. 백엔드 엔지니어 홍서현의 회고와 기록 공간입니다.',
  
  // 키워드 강화 (검색 잘 되게)
  keywords: ['홍서현','백엔드 개발 블로그','백엔드 기술 블로그', 'SH380', '백엔드', '기술 블로그', 'Spring Boot', 'Kubernetes', 'docker','backend', 'developer', 'programming', 'web development', 'python', 'server', 'cloud', 'infrastructure'],
