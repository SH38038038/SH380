...
import remarkGfm from "remark-gfm"; // 👈 1. 여기 import 추가
  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-6">
      ...
      <article className="text-gray-800 leading-relaxed">
        <ReactMarkdown
          // 👈 2. remarkGfm을 여기에 반드시 추가해야 표를 인식합니다!
          ...
          components={{
            ...
            blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-gray-300 pl-4 py-1 my-6 text-gray-600 italic bg-gray-50" {...props} />,
            ...
            code: ({ node, ...props }) => <code className="bg-gray-100 px-1.5 py-0.5 rounded text-red-500 font-mono text-sm border border-gray-200" {...props} />,
            ...
            td: ({ node, ...props }) => (
              <td className="px-4 py-3 text-sm text-gray-600 align-top" {...props} />
            ),
          }}
        >
          {post.content}
